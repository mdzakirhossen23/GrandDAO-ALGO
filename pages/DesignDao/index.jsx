...
export default function DesignDao() {
  ...
  const { getMapValue, payToApp, appClient,getRecordFromDB , accountAddress,stringToBytes  } = useAlgoContext();
  ...
  async function LoadEditor() {
    if (typeof window == 'undefined' || id === null || appClient == null ||  !accountAddress?.address ) {
      return null;
    }
